...
<script>
    ...
    $(document).ready(function () {
        oTable = $('#PRData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('products/getProducts'.($warehouse_id ? '/'.$warehouse_id : '').($konsi ? '?konsi='.$konsi : '')) ?>',
                ...
                <?php if (!empty($warehouses)) { ?>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                            ...
                            ?>
                            <li>
                                <a href="<?= site_url('products?konsi=konsi') ?>">
                                    <i class="fa fa-hand-grab-o"></i> <?= lang('konsi_products') ?>
                                </a>
                            </li>
                            <li>
                                <a href="<?= site_url('products?konsi=bukan_konsi') ?>">
                                    <i class="fa fa-hand-stop-o"></i> <?= lang('non_konsi_products') ?>
                                </a>
                            </li>
                        </ul>
                    </li>
