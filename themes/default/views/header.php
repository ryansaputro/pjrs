                        ...
                        if ($Owner || $Admin) {
                            ...
                            <li class="mm_sales <?= strtolower($this->router->fetch_method()) == 'sales' ? 'mm_pos' : '' ?>">
                                ...
                                <ul>
                                    ...
                                    <li id="sales_add">
                                        <a class="submenu" href="<?= site_url('reward/claim_point'); ?>">
                                            <i class="fa fa-rocket"></i>
                                            <span class="text"> <?= lang('claim_point'); ?></span>
                                        </a>
                                    </li>
 ...
 -->
                            ...
                            <li class="mm_reports">
                                ...
                                <ul>
                                    ...
                                    <li id="reports_custom_sales">
                                        <a href="<?= site_url('reports/custom_sales') ?>">
                                            <i class="fa fa-heart"></i><span class="text"> <?= lang('custom_sales'); ?></span>
                                        </a>
                                    </li>
                        ...
                        <?php
                            ...
                            <li class="mm_reports">
                                ...
                                <ul>
                                    ...
                                    <li id="reports_custom_sales">
                                        <a href="<?= site_url('reports/custom_sales') ?>">
                                            <i class="fa fa-calendar-o"></i><span class="text"> <?= lang('custom_sales'); ?></span>
                                        </a>
                                    </li>
                                    <?php }
                                    if ($GP['reports-sales']) { ?>
