                ...
                <div class="container padding-y-md">
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-md-3 logo">
                            <a href="<?= site_url(); ?>">
                                <img alt="Logo" src="<?= $assets; ?>/images/sma-shop.png" class="img-responsive" />
                            </a>
                        </div>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    foreach($categories as $pc) {
                                        ...
                                        echo '<a '.($pc->subcategories ? 'class="dropdown-toggle" data-toggle="dropdown"' : '').' href="'.shop_url('category/'.$pc->slug).'">'.$pc->name.'</a>';
                                        if ($pc->subcategories) {
                                            echo '<ul class="dropdown-menu">';
                                            foreach($pc->subcategories as $sc) {
                                                echo '<li><a href="'.shop_url('category/'.$sc->slug).'">'.$sc->name.'</a></li>';
                                            }
                                            echo '</ul>';
                                        }
                                        echo '</li>';
                                ...
                                if (count($brands) <= 10) {
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        foreach($brands as $brand) {
                                            echo '<li><a href="'.shop_url('brand/'.$brand->slug).'" class="line-height-lg">'.$brand->name.'</a></li>';
                                        }
                                        ?>
                                    </ul>
                                    <?php
