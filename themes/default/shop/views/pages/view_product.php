                                    ...
                                    <div class="col-sm-5">
                                        ...
                                        <!-- <div class="form-group">
                                            <div class="input-group">
                                                <span class="input-group-addon btn-minus"><span class="fa fa-minus"></span></span>
                                                <input type="text" name="quantity" class="form-control text-center" value="1" required="required">
                                                <span class="input-group-addon btn-plus"><span class="fa fa-plus"></span></span>
                                            </div>
                                        </div> -->
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-striped dfTable table-right-left">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><?= lang("brand"); ?></td>
                                                        <td><?= $brand ? '<a href="'.shop_url('brand/'.$brand->slug).'" class="line-height-lg">'.$brand->name.'</a>' : ''; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td><?= lang("category"); ?></td>
                                                        <td><?= '<a href="'.shop_url('category/'.$category->slug).'" class="line-height-lg">'.$category->name.'</a>'; ?></td>
                                                    </tr>
                                                    <?php if ($product->subcategory_id) { ?>
                                                    <tr>
                                                        <td><?= lang("subcategory"); ?></td>
                                                        <td><?= '<a href="'.shop_url('category/'.$subcategory->slug).'" class="line-height-lg">'.$subcategory->name.'</a>'; ?></td>
                                                    </tr>
                                                    <?php } ?>
