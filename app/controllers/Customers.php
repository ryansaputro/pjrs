...
class Customers extends MY_Controller
{
    ...
    function getCustomers()
    {
        ...
        $this->datatables
            ->select("id, company, name, email, phone, price_group_name, customer_group_name, vat_no, award_points")
            ->from("companies")
    ...
    function getCustomer($id = NULL)
    {
        ...
        $this->sma->send_json(array(array('id' => $row->id, 'text' => ($row->name != '-' ? $row->name : $row->name))));
    }
